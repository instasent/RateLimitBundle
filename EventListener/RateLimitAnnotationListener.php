...
namespace Instasent\RateLimitBundle\EventListener;
...
class RateLimitAnnotationListener extends BaseListener
{
    ...
    /**
     * @var \Instasent\RateLimitBundle\Service\RateLimitService
     */
    protected $rateLimitService;

    /**
     * @var \Instasent\RateLimitBundle\Util\PathLimitProcessor
     */
